# REVERSE Health Tracker

Kotlin Multiplatform implementation of the REVERSE anti-aging routine tracker for Android and iOS.
...
- Menu tab with user points and REVERSE service links.
...
For iOS framework verification:

```sh
./gradlew :composeApp:linkDebugFrameworkIosSimulatorArm64
```

The Swift files in `iosApp/iosApp` call `MainViewController()` from the generated `ReverseHealthTracker` framework. See `iosApp/README.md` for Xcode wiring.
